\\maketitle
\\begin{abstract}
    本文针对2020年CUMCM A题停车场定价与车位分配问题，建立了基于Stackelberg博弈的停车价格策略优化模型。首先分析车主停车行为特征和停车场运营现状；其次构建运营商与车主之间的Stackelberg主从博弈模型；最后求解均衡解并进行灵敏度分析。
    
    \\textbf{针对问题一}，我们分析了车主停车行为。通过问卷调查和数据分析，建立MNL选择概率模型：
